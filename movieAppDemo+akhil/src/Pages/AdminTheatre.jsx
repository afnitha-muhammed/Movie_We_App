...
import { addTheatreApi, deleteTheatreApi, getTheatreApi } from '../services/allApi';
    ...
    <div className="row">
      ...
      <div className="container-fluid mt-5">
        ...
        <div className='d-flex justify-content-between shadow bg-secondary p-3'>
            ...
            <button type="button" class="btn btn-warning" onClick={() => setOpen(!open)}>Add New</button>
        </div>
        <Collapse in={open}>
        ...
        <div className="mb-3">
            <label>Name</label>
            <input type="text" className='form-control w-100' onChange={(e)=>setTheatre({...Theatre,Name:e.target.value})} />
        </div>
        <div className="mb-3">
            <label>Address</label>
            <input type="text" className='form-control w-100' onChange={(e)=>setTheatre({...Theatre,Address:e.target.value})} />
        </div>
        {/* <div className="mb-3">
        ...
        <div className="mb-3">
        <button type="button" class="btn btn-success" fdprocessedid="qvbdkp" onClick={handleUpload}>Add</button>
        </div>
        </form>
        </div>
        </Collapse>
       ...
       <Card style={{ width: '100%' }} className='mt-2'>
         <Card.Body>
           <div className="d-flex justify-content-between">
             <Card.Title className='' style={{fontWeight:'700'}}>{item.Name}</Card.Title>
             <div  className='ms-auto'>
               <Button variant="secondary" className='ms-2' onClick={() => setOpen(!open)}>
           ...
           <button type="button" className="btn btn-dark" fdprocessedid="szfewf">Update</button>
           <button type="button" className="btn btn-warning ms-2" fdprocessedid="szfewf" onClick={()=>handleDelete(item?.id)}>Delete</button>
           </div>
           </Collapse>
